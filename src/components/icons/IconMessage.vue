<template>
  <!-- solid svg -->
  <svg v-if="active" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
  ...
  <!-- outline svg -->
  <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
    <!-- !Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc. -->
    <path
